...
当前阶段：统一拉帧 + Metal 直通 + Anime4K Fast A + 流畅档三态（关 / 快 VT / 高质量 IFRNet-S）。mkv / webm / avi / ts / flv 走 FFmpeg。字幕按架构分期，不要提前做。
...
Sources/Enhance    FrameProcessor；Anime4K Fast A；流畅档（VT 快 / IFRNet-S 高质量）
